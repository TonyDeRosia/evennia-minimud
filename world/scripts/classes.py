CLASS_LIST = [
    ...
    },
    {
        ...
        "stat_mods": {"INT": 2, "WIS": 2, "LUCK": -1}  # replaced CHA with LUCK or removed
    },
    {
        "name": "Spellbinder",
    ...
    },
    {
        ...
        "stat_mods": {"INT": 2, "LUCK": 2}  # replaced CHA with LUCK, or just remove if not wanted
    },
    {
        "name": "Bard",
        "desc": "A charismatic performer wielding magic through music and story.",
        "stat_mods": {"LUCK": 2, "INT": 2}  # replaced CHA with LUCK or INT, as fits your design
    },
    {
        "name": "Swashbuckler",
